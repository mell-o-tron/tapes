...
type decl = ExprDecl of iden * exprtype * expr | SortDecl of iden | GenDecl of iden * Terms.obj * Terms.obj

type program = Comm of command | Decl of decl | Set of iden * float | Seq of program * program
