...
\pgfmathsetmacro{\innerarclenr}{\arclenr - \h}

\pgfmathsetmacro{\arclenl}{(\toplanetop - \ly) / 2}
\pgfmathsetmacro{\innerarclenl}{\arclenl - \h}

\pgfmathsetmacro{\wirearclenl}{(\toplanebase - \ly) / 2}
\pgfmathsetmacro{\wirearclenr}{(\toplanebase - \ry) / 2}
...
\draw [tapeBorder] (\lx, \ly + \height) arc (270 : 90: \innerarclenl) -- (\rx, \maxy + \oplusdist) arc (90 : -90 : \innerarclenr);
    ...
    \else
     \pgfmathsetmacro{\ishift}{\tapepadding + (\i - 1) * \otimesdist}
      ...
      \draw (\rx, \ry + \ishift) arc (-90 : 90 : \wirearclenr) -- (\lx, \maxy + \oplusdist + \ishift) arc (90 : 270 : \wirearclenl);
