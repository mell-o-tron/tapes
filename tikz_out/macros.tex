...
trianglestyle/.style={isosceles triangle, inner sep = 0pt, outer sep = 0pt, draw, fill=white},
circlestyle/.style={circle, inner sep = 2pt, outer sep = 0pt, draw, fill=white},
}
...
% fresh posx posy arity coarity name otimesdist style
\newcommand{\gen}[8]{
...
\let\coarshift\pgfmathresult
  ...
  \pgfmathsetmacro\boxheight{\height / 2}
  
  %draw box with name
  \node [#8, minimum height = \boxheight cm] at (#2 + 1,#3 + \height / 2) {#6};
}
